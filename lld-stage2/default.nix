{ busybox-bin, make-tmp, cmake-tmp, python3-tmp, zlib-tmp, git-tmp, llvm-stage2, clang-stage2, lld-stage1, musl-stage1, compiler-rt-stage1, libunwind-stage1, libcxx-stage1 }:

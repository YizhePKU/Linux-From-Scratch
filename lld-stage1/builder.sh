...
export LDFLAGS="-nostdinc -L$gcc/lib -L$gcc/lib/gcc/x86_64-linux-musl/11.2.1 -L$gcc/lib/gcc -L$gcc/x86_64-linux-musl/lib -Wl,--dynamic-linker=$gcc/lib/libc.so -Wl,--enable-new-dtags -Wl,--rpath=$gcc/lib -Wl,--rpath=$zlib/lib"
